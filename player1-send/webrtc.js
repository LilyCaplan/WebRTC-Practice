...
function startClick() {
	...
	setInterval(function (){
		document.write('click '+count+' from self' + '<br />');
		dataChannel.send('click '+count+' from '+id);
		count++;
    //this is like saying count = count + 1; so it is just incrementing by 1 every second
	},1000);
}
...
//firebase config
var config = {
	apiKey: "AIzaSyDyeCqBOgoUIQyQdMfVr8zd7UAW83vW4zg",
	authDomain: "peertempo-85416.firebaseapp.com",
	databaseURL: "https://peertempo-85416.firebaseio.com",
	storageBucket: "peertempo-85416.appspot.com",
	messagingSenderId: "506457670669"
};
